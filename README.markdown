What is JSIO? [![Build Status](https://travis-ci.org/alanshaw/JavaScript-Image-Optimiser.png)](https://travis-ci.org/alanshaw/JavaScript-Image-Optimiser) [![Dependency Status](http://david-dm.org/alanshaw/JavaScript-Image-Optimiser/status.png)](http://david-dm.org/alanshaw/JavaScript-Image-Optimiser)
=============
